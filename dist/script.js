...
function (_Slider) {
  ...
  function MainSlider(container, next, prev, activeClass, animate, autoplay) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, container, next, prev, activeClass, animate, autoplay));
  }
